...
ingestion, structured extraction, and knowledge indexing are in place.
Retrieval and routing are the main pending pieces now.
...
1. Add retrieval with source citations
2. Add routing and decision workflows
